...
@SourceType(value = "ApachePhoenixARP", label = "ApachePhoenix",uiConfig = "apachephoenix-layout.json")
public class ApachePhoenixConf extends AbstractArpConf<ApachePhoenixConf> {
  private static final String ARP_FILENAME = "arp/implementation/apachephoenix-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.apachephoenix.ApachePhoenixDriver";
